...
const Appointment = () => {
  ...
  const fetchDocInfo = async () => {
    ...
    setDocInfo(docInfo);
    console.log("document object is", docInfo);
  }
  ...
  const getAvailableSlot = async () => {
    ...
    let today = new Date();
    // After this we will get the date object in this today variable. And with this today variable, we can calculate the total 7 days.
    for (let i=0; i<7; i++) {
      // getting 7 days wit index;
  ...
  const bookAppointment = async () => {
    ...
    try {
      const date = docSlot[slotIndex][0].dateTime; // Here we can get our date and time of the booked slot
      // Further we will destructure it to get differnet values from date time and we will store them in different variables
  ...
  return docInfo && (
    <div>
      ...
      {/* After that we have to make the UI of booking slots, for it we have to get the data of current date and time and after that I will have the data of total 7 days.  */}
